/**
 * API Route: /api/parse-file
 * Accepts CSV or Excel file and returns parsed student data
 */

import { NextRequest, NextResponse } from 'next/server';
import { parseCSV, parseExcel, validateStudentData, getDataStats } from '@/lib/parsers';
